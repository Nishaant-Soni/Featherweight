...
- [ ] **Phase 5 — Hyperparameter pass** *(lean sweep targeting the irrelevance regression; Group A: `eval/sweep.py` run spec + exact-match-with-refusal-floor selector + `sweep.{csv,md}` writer + tests ✅; Groups B+C pending)*
